<%@ Page Title="Parolayı Sıfırla" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="Havaalani.Account.ResetPassword" Async="true" %>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <asp:Button runat="server" OnClick="Reset_Click" Text="Sıfırla" CssClass="btn btn-default" />
            </div>
        </div>
    </div>
</asp:Content>
