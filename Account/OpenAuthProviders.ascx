<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Havaalani.Account.OpenAuthProviders" %>
        ...
        <ItemTemplate>
            <p>
                <button type="submit" class="btn btn-default" name="provider" value="<%#: Item %>"
                    title="Hesabınızı kullanarak oturum<%#: Item %> açın.">
                    <%#: Item %>
                </button>
            </p>
        </ItemTemplate>
